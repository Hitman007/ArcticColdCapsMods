...
add_action('woocommerce_payment_complete_order_status', 'CustomRayGuns\shouldDetectProductPayment', 10, 2);
function shouldDetectProductPayment($order_status, $order_id) {
